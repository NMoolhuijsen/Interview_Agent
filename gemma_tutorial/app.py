import PyPDF2
from langchain_community.embeddings import OllamaEmbeddings, HuggingFaceInstructEmbeddings, GPT4AllEmbeddings
...
async def on_chat_start():
    ...
    # embeddings = HuggingFaceInstructEmbeddings(model_name="hkunlp/instructor-xl")	# slow
    ...
    chain = ConversationalRetrievalChain.from_llm(
        llm = HuggingFaceHub(repo_id="google/gemma-7b"),               # llm = ollama(model="gemma:2b") for non-local
        chain_type="stuff",
